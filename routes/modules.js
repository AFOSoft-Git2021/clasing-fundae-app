...
const { getWorkSessionType, getWorkSessionInfo, getWorkSession, setWorkSessionActivityResponse, getWorkSessionStatistics, initWorkSession, resetWorkSession } = require("../controllers/ModuleController");
...
route.get ('/reset-work-session', verifyToken, resetWorkSession);
